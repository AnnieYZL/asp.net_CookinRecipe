...
string connectionString = @"server=ANNIEYZL\ANNIE;user id = sa;password=123;database= CookinRecipe;TrustServerCertificate=true";
CookinRecipe.BusinessLayers.Configuration.Initialize(connectionString);
app.Run();